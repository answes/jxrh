...
public class NewsController implements Initializable{
    ObservableList<News> list = FXCollections.observableArrayList(new News(1L,"2018-05-05 00:00:00","一带一路”政策密集出台 今年有望纵深推进今年有望纵深推进今年有望纵深推进"),new News(2L,"2018-05-05 00:00:00","新闻标题不想说什么")
